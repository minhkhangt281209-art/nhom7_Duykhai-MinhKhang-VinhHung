...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($full_name) || empty($email) || empty($password)) {
        ...
        if ($stmt->fetch()) {
            ...
            // Chèn dữ liệu mới vào bảng users (mặc định là vai trò 'customer')
            $sql = "INSERT INTO users (full_name, email, password, phone, address, role) VALUES (?, ?, ?, ?, ?, 'customer')";
            ...
            <div class="glass-card p-5">
                ...
                <form method="POST" action="register.php">
                    <div class="mb-3">
                        ...
                        <input type="text" name="full_name" class="form-control rounded-pill px-3" required placeholder="Nguyễn Văn A">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control rounded-pill px-3" placeholder="0901234567">
                    </div>
                    <div class="mb-4">
                        <label class="form-label small fw-bold">Địa chỉ giao hàng</label>
                        <textarea name="address" class="form-control rounded-3" rows="2" placeholder="Số nhà, tên đường, quận/huyện..."></textarea>
                    </div>
