...
// 1. Tính toán các con số tổng quan (Đã sửa tên cột và trạng thái theo CSDL mới)
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <span class="badge bg-white text-dark border p-2">
        <i class="bi bi-calendar3 me-2"></i>Hôm nay: <?php echo date('d/m/Y'); ?>
    </span>
</div>

<!-- KHU VỰC THẺ THỐNG KÊ SỐ LIỆU -->
<div class="row g-4 mb-4">
    <div class="col-md-3">
        <div class="card admin-card p-4 bg-white border-0 shadow-sm rounded-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="bg-success bg-opacity-10 p-3 rounded-3 text-success fs-3 lh-1">
    ...
    <div class="col-md-3">
        <div class="card admin-card p-4 bg-white border-0 shadow-sm rounded-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="bg-primary bg-opacity-10 p-3 rounded-3 text-primary fs-3 lh-1">
    ...
    <div class="col-md-3">
        <div class="card admin-card p-4 bg-white border-0 shadow-sm rounded-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="bg-danger bg-opacity-10 p-3 rounded-3 text-danger fs-3 lh-1">
    ...
    <div class="col-md-3">
        <div class="card admin-card p-4 bg-white border-0 shadow-sm rounded-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="bg-warning bg-opacity-10 p-3 rounded-3 text-warning fs-3 lh-1">
...
<!-- KHU VỰC BIỂU ĐỒ VÀ BẢNG ĐƠN HÀNG MỚI NHẤT -->
<div class="row g-4"> 
    <div class="col-lg-4">
        <div class="card admin-card p-4 bg-white border-0 shadow-sm rounded-4 h-100">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover align-middle small">
                    ...
                    <tbody>
                        <?php
                        // Sửa câu truy vấn lấy danh sách đơn hàng khớp với các trường dữ liệu mới
                        ...
                        <tr>
                            ...
                            <!-- Sửa đổi từ customer_name thành full_name -->
                            <td><?php echo htmlspecialchars($o['full_name']); ?></td>
                            <!-- Sửa đổi từ order_status thành status -->
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-secondary rounded-pill"><?php echo $o['status']; ?></span>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php 
                        ...
                        ?>
                        <tr>
                            <td colspan="3" class="text-center text-muted py-3">Chưa có đơn hàng nào.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
